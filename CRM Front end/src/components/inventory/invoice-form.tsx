...
import { getSalesOrders, getTaxRates } from "@/lib/api/inventory";
import {
...
export function InvoiceForm({
  ...
  const [activeSection, setActiveSection] = useState("invoice-details");
  ...
  return (
    <div className="flex h-[calc(100vh-13rem)]">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto pl-6">
        ...
        >
        {/* ────────────── Invoice Details ────────────── */}
        <section id="invoice-details" className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input {...register("subject")} placeholder="Invoice subject" />
              {errors.subject && (
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setValue("corporation", v === "__none__" ? "" : v)
                }
              >
                <SelectTrigger>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setValue("sales_order", v === "__none__" ? "" : v)
                }
              >
                <SelectTrigger>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setValue("assigned_to", v === "__none__" ? "" : v)
                }
              >
                <SelectTrigger>
        ...
        <section id="address-details" className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>Address</Label>
                <Input {...register("billing_street")} placeholder="Street address" />
              </div>
              <div className="space-y-2">
                <Label>PO Box</Label>
                <Input {...register("billing_po_box")} />
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>Address</Label>
                <Input {...register("shipping_street")} placeholder="Street address" />
              </div>
              <div className="space-y-2">
                <Label>PO Box</Label>
                <Input {...register("shipping_po_box")} />
              </div>
              <div className="grid grid-cols-3 gap-3">
                <div className="space-y-2">
                  <Label>City</Label>
          ...
          <div className="flex justify-end">
            <div className="w-full max-w-sm space-y-2 rounded-lg border p-4">
              ...
              <div className="flex items-center justify-between gap-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  <Select
                    value={discountMode}
                    onValueChange={(v) =>
                      setDiscountMode(v as "percent" | "amount")
                    }
                  >
              ...
              {overallDiscount > 0 && (
                <div className="flex justify-between text-sm text-destructive">
                  ...
                  <span className="font-mono">
                    -$
                    {overallDiscount.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </span>
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-mono font-medium">
                  $
                  {preTaxTotal.toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                </span>
        ...
        <div className="border-t pt-4 flex gap-3">
          <Button type="submit" disabled={isLoading}>
            {isLoading ? "Saving..." : isEdit ? "Update Invoice" : "Save Invoice"}
          </Button>
        </div>
      </form>
      </div>
