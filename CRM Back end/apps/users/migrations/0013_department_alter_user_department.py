    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#6366f1', help_text='Hex color code for UI display', max_length=7, verbose_name='color')),
                ('icon', models.CharField(blank=True, default='', help_text='Lucide icon name for UI display', max_length=50, verbose_name='icon')),
                ('is_active', models.BooleanField(default=True, verbose_name='active')),
                ('order', models.PositiveIntegerField(default=0, help_text='Order in which departments appear in lists', verbose_name='display order')),
