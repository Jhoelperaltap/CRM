            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="All conditions must be met.",
                        verbose_name="all conditions",
                    ),
                ),
                (
                    "entry_criteria_any",
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="At least one condition must be met.",
                        verbose_name="any conditions",
                    ),
                ),
                (
                    "apply_on",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "action_config",
                    models.JSONField(
                        blank=True, default=dict, verbose_name="action config"
                    ),
                ),
                ("is_active", models.BooleanField(default=True, verbose_name="active")),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=1, verbose_name="rule number"
                    ),
                ),
                (
                    "conditions",
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="Conditions for this rule to match.",
