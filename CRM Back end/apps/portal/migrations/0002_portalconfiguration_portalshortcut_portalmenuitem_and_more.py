            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        default="",
                        help_text="The public URL of the customer portal.",
                        max_length=500,
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=7,
                        help_text="Days before expiration to notify support.",
                        verbose_name="contact support notification (days before)",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        verbose_name="login details template",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        verbose_name="forgot password template",
                    ),
                ),
                (
                    "custom_css_url",
                    models.URLField(
                        ...
                        default="",
                        max_length=500,
                        verbose_name="CSS URL for custom theme",
                    ),
                ),
                (
                    "default_scope",
                    models.CharField(
                        choices=[("all", "All"), ("own", "Own Records Only")],
                        default="all",
                        max_length=20,
                        verbose_name="default scope",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        default="4",
                        max_length=5,
                        verbose_name="inactive portal session logout interval",
                    ),
                ),
                (
                    "announcement_html",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("standard", "Standard greeting"),
                            ("time_based", "Time based greeting"),
                        ],
                        default="standard",
                        max_length=20,
                        verbose_name="greeting type",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        verbose_name="account representatives widget enabled",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        verbose_name="recent documents record widget enabled",
                    ),
                ),
                (
                    "recent_faq_widget_enabled",
                    models.BooleanField(
                        default=True, verbose_name="recent FAQ record widget enabled"
                    ),
                ),
                (
                    "recent_cases_widget_enabled",
                    models.BooleanField(
                        default=True, verbose_name="recent cases record widget enabled"
                    ),
                ),
                (
                    "chart_open_cases_priority",
                    models.BooleanField(
                        default=True, verbose_name="chart: open cases by priority"
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        verbose_name="chart: cases resolution time by priority",
                    ),
                ),
                (
                    "chart_projects_by_status",
                    models.BooleanField(
                        default=False, verbose_name="chart: projects by status"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "module_name",
                    models.CharField(
                        help_text="Internal module identifier, e.g., 'cases', 'invoices'.",
                        max_length=100,
                ...
                (
                    "label",
                    models.CharField(
                        help_text="Display label in the portal menu.",
                        max_length=100,
                        verbose_name="label",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "module_name",
                    models.CharField(
                        help_text="Module: 'contacts' or 'organizations'.",
                        max_length=100,
                        verbose_name="module name",
                    ),
                ),
                ...
                (
                    "field_label",
                    models.CharField(max_length=100, verbose_name="field label"),
                ),
                (
                    "permission",
                    models.CharField(
