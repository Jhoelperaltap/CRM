...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='contact',
            name='corporations',
            field=models.ManyToManyField(blank=True, related_name='contacts_new', to='corporations.corporation', verbose_name='corporations'),
        ),
        migrations.AddField(
            model_name='contact',
            name='primary_corporation',
            field=models.ForeignKey(blank=True, help_text='Main corporation for this contact', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='primary_contacts', to='corporations.corporation', verbose_name='primary corporation'),
        ),
        ...
        migrations.AlterField(
            model_name='contact',
            name='corporations',
            field=models.ManyToManyField(blank=True, related_name='contacts', to='corporations.corporation', verbose_name='corporations'),
        ),

        # Step 5: Add new index
        migrations.AddIndex(
            model_name='contact',
            index=models.Index(fields=['primary_corporation', 'status'], name='idx_contact_prim_corp_status'),
        ),
    ]
