...
urlpatterns = [
    ...
    path("activities-completed/", ActivitiesCompletedView.as_view(), name="activities-completed"),
    path("activity-efficiency/", ActivityEfficiencyView.as_view(), name="activity-efficiency"),
    ...
    path("pipeline-activity/", PipelineActivityView.as_view(), name="pipeline-activity"),
    path("funnel-progression/", FunnelProgressionView.as_view(), name="funnel-progression"),
    ...
    path("sales-cycle-duration/", SalesCycleDurationView.as_view(), name="sales-cycle-duration"),
