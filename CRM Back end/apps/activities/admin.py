...
class ActivityAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("activity_type", "title", "description")}),
        ...
        ("Metadata", {"fields": ("performed_by", "department", "metadata")}),
        (
            "Timestamps",
...
class CommentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("author", "content")}),
        ("Entity", {"fields": ("content_type", "object_id")}),
        ("Reply", {"fields": ("parent",), "classes": ("collapse",)}),
        ("Mentions", {"fields": ("mentioned_users",)}),
        ("Status", {"fields": ("is_deleted", "is_edited", "edited_at")}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
